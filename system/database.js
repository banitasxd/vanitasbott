module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'vanitas'
      if (!('sk_author' in setting)) setting.sk_author = '@mohammed_xf16'
      ...
      if (!('owners' in setting)) setting.owners = ['212630215371', '212630215371']
      if (!('msg' in setting)) setting.msg = '*╭ • ━────━﹝•💠•﹞━────━ • ╮* /n*✦║. القوانين🧧║✦*/n*↫ 「📜1:ممنوع سبام: 」*/n*↫ 「📜2:ممنوع أي شيئ يغضب الله: 」*/n*↫ 「📜3:ممنوع خاص: 」*/n*╮* /n*✦║لو تبي البوت كلم المطور🧧║✦*/n*╰ • ━────━﹝•💠•﹞━────━ • ╯*/n *╭ • ━────━﹝•💠•﹞━────━ • ╮* /nمايكي/n*╰ • ━────━﹝•💠•﹞━────━ • ╯*'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         pluginDisable: [],
         sk_pack: 'vanitas',
         sk_author: '@mohammed_xf16',
         self: false,
         mimic: [],
         multiprefix: true,
         prefix: ['.', '#', '!', '/'],
         toxic: ["ajg", "ajig", "anjas", "anjg", "anjim", "anjing", "anjrot", "anying", "asw", "autis", "babi", "bacod", "bacot", "bagong", "bajingan", "bangsad", "bangsat", "bastard", "bego", "bgsd", "biadab", "biadap", "bitch", "bngst", "bodoh", "bokep", "cocote", "coli", "colmek", "comli", "dajjal", "dancok", "dongo", "fuck", "gelay", "goblog", "goblok", "guoblog", "guoblok", "hairul", "henceut", "idiot", "itil", "jamet", "jancok", "jembut", "jingan", "kafir", "kanjut", "kanyut", "keparat", "kntl", "kontol", "lana", "loli", "lont", "lonte", "mancing", "meki", "memek", "ngentod", "ngentot", "ngewe", "ngocok", "ngtd", "njeng", "njing", "njinx", "oppai", "pantek", "pantek", "peler", "pepek", "pilat", "pler", "pornhub", "pucek", "puki", "pukimak", "redhub", "sange", "setan", "كس", "telaso", "نيك", "tete", "titit", "toket", "tolol", "tomlol", "tytyd", "wildan", "xnxx"],
         online: true,
         onlyprefix: '+',
         owners: ['212630215371', '212630215371'],
         msg: '*╭ • ━────━﹝•💠•﹞━────━ • ╮* /n*✦║. القوانين🧧║✦*/n*↫ 「📜1:ممنوع سبام: 」*/n*↫ 「📜2:ممنوع أي شيئ يغضب الله: 」*/n*↫ 「📜3:ممنوع خاص: 」*/n*╮* /n*✦║لو تبي البوت كلم المطور🧧║✦*/n*╰ • ━────━﹝•💠•﹞━────━ • ╯*'
      }
   }
}